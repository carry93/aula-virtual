...
app.post('/api/student/vote', requireToken, (req, res) => {
    ...
    if (currentPoll && currentPoll.id === pollId) {
        if (currentPoll.options[optionIndex] !== undefined) {
...
app.get('/api/admin/status', (req, res) => {
    ...
    res.json({ 
        ...
        locked: submissionsLocked, timerEndTime, announcement: latestAnnouncement, 
        questions: studentQuestions, snippet: liveSnippet, poll: currentPoll,
        maxFileSizeMB
    });
});
...
app.post('/api/admin/close', (req, res) => {
    ...
    submissionsLocked = false; timerEndTime = null; latestAnnouncement = null;
    studentQuestions = []; liveSnippet = ""; currentPoll = null;
